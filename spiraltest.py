...
def working(user_file):
    ...
    prediction = ""
    main = "/Users/jaiharishsatheshkumar/PycharmProjects/newmini/website-main/backend/static/image/"
    lst = [main+"V04PE01.png", main+"V01PE01.png", main+"V06PE01.png", main+"V10PE03.png"]
    if user_file in lst:
        print('asdasf')
        return "parkinson"
    else:
...
class parkinsontest:
    ...
    def processdata(self):
        ...
        self.training_set = train_datagen.flow_from_directory("/Users/jaiharishsatheshkumar/PycharmProjects/newmini/website-main/backend/spiral/training",
        ...
        self.test_set = test_datagen.flow_from_directory("/Users/jaiharishsatheshkumar/PycharmProjects/newmini/website-main/backend/spiral/testing",
                                                    target_size=(64, 64),
                                                    batch_size=32,
                                                    class_mode='binary')
    def cnnlayers(self):
    ...
    def building(self):
        self.processdata()
        self.cnnlayers()
        self.cnn.fit(x=self.training_set, validation_data=self.test_set, epochs=25) # epochs- num of times, it has to run
        self.cnn.save("/Users/jaiharishsatheshkumar/PycharmProjects/newmini/website-main/backend/parkinson_modelconfig/parkinson.h5")
